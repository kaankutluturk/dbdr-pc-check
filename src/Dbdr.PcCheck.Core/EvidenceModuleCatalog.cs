...
public static class EvidenceModuleCatalog
{
    ...
    [
        New("winprefetch", "WinPrefetch View", "Execution", ModuleAvailability.Preview,
            ...
            "Bounded parser emits executable identity and parsed run timestamps; referenced-file and volume lists remain excluded.",
        ...
        New("string-explorer", "String Explorer", "Binary triage", ModuleAvailability.Preview,
            "Searchable PE sections, imports and binary triage for files already referenced by collected evidence.",
            "No arbitrary disk crawl, arbitrary string extraction or process-memory strings.",
            false, "file.metadata", "process.module", "sections", "imports", "entropy", "yara"),
        ...
        New("paths", "Paths Parser", "File activity", ModuleAvailability.Preview,
            "Correlates exact redacted executable paths across approved usage, live-module and persistence evidence.",
            "No disk crawl, LNK/Jump List parsing or personal recent-file path collection; a path match requires an independent binary review signal.",
            false, "path", "correlation", "execution.srum_application"),
        ...
        New("journal-trace", "Journal Trace", "File system", ModuleAvailability.Preview,
            "Time-bounded executable/script NTFS USN journal activity.",
            "Read-only journal-tail parser with strict caps and no parent-path or file-reference serialization; journal truncation is a coverage gap.",
            true, "$j", "usn", "journal"),
        ...
        New("srum", "SRUM Explorer", "Execution", ModuleAvailability.Preview,
            "Opt-in, time-bounded executable application-usage buckets from Windows powercfg.",
            "Only executable name, redacted path and source timestamp survive minimization; user IDs, network fields and usage amounts are discarded.",
            true, "srum", "powercfg", "execution.srum_application"),
        New("binary-triage", "YARA + Entropy", "Binary triage", ModuleAvailability.Available,
            "Hashes, Authenticode, PE structure/imports, Shannon entropy and bounded YARA rule matching.",
            "Only files already referenced by approved process/module/persistence evidence are opened; every signal is a review lead.",
            false, "yara", "entropy", "sha256", "authenticode", "pe", "imports", "rwx"),
    ];
