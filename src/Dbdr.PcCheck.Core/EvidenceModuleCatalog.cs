...
public static class EvidenceModuleCatalog
{
    ...
    [
        ...
        New("powershell", "PowerShell Parser", "Execution", ModuleAvailability.PrivacyRestricted,
            "PowerShell execution artifacts.",
            "Command and terminal history are excluded; a future adapter may expose privacy-safe engine metadata only.",
            true, "powershell", "event log"),
        ...
        New("journal-trace", "Journal Trace", "File system", ModuleAvailability.Planned,
            ...
            true, "$j", "usn", "journal"),
        New("crashed-files", "Crashed File Viewer", "Reliability", ModuleAvailability.Planned,
            "Windows Error Reporting crash metadata and referenced executable identity.",
            "No crash dumps or memory-derived content are collected.",
            true, "wer", "crash", "reliability"),
        ...
        New("amcache", "Amcache Parser", "Execution", ModuleAvailability.Planned,
            "Amcache program and file observations with explicit timestamp semantics.",
            "Requires locked-hive handling, redaction and schema tests before enablement.",
            true, "amcache", "inventoryapplication"),
